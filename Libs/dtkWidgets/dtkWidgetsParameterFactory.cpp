...
dtkWidgetsParameter *dtkWidgetsParameterFactory::create(const QString &key)
{
    ...
    if (!widget) {
        qWarning() << Q_FUNC_INFO << "The widget with key :" << key
...
dtkWidgetsParameter *dtkWidgetsParameterFactory::create(dtkCoreParameter *parameter,
                                                        const QString &key)
{
    if (!parameter) {
...
namespace _private {
// dtkCorePluginManagerRecorder mrecorder(&dtk::widgets::manager(),
// &pluginManager(), "dtkWidgetsParameter"); dtkCorePluginFactoryRecorder
// frecorder(&dtk::widgets::manager(), &pluginFactory(), "dtkWidgetsParameter");
}
} // namespace parameters
} // namespace widgets
} // namespace dtk
