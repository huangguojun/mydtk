...
template<typename T>
struct dtkArrayDataTemplate;

template<>
struct dtkArrayDataTemplate<qint32>
{
public:
    dtkArrayDataTemplate(void) {}
    dtkArrayDataTemplate(int r, qint32 s, quint32 a, quint32 c, qptrdiff o)
        : size(s), alloc(a), capacityReserved(c), offset(o)
    {
        ref.atomic.store(r);
    }
...
template<>
struct dtkArrayDataTemplate<qint64>
{
public:
    dtkArrayDataTemplate(void) {}
    dtkArrayDataTemplate(int r, qint64 s, quint64 a, quint64 c, qptrdiff o)
        : size(s), alloc(a), capacityReserved(c), offset(o)
    {
        ref.atomic.store(r);
    }
...
public:
    ...
    dtkArrayData(int r, qintptr s, quintptr a, quintptr c, qptrdiff o)
        : dtkArrayDataBase(r, s, a, c, o)
    {
    }
...
public:
    static dtkArrayData *allocate(size_t objectSize, size_t alignment, size_t capacity,
...
template<typename T>
struct dtkTypedArrayData : dtkArrayData
{
public:
...
public:
    ...
    static dtkTypedArrayData *fromRawData(const T *data, qintptr n,
                                          AllocationOptions options = Default);
...
template<typename T>
inline dtkTypedArrayData<T>::dtkTypedArrayData(const dtkTypedArrayData &other)
    : dtkArrayData(other.ref.atomic.load(), other.size, other.alloc, other.capacityReserved,
                   other.offset)
{
}

template<typename T>
inline dtkTypedArrayData<T> *dtkTypedArrayData<T>::allocate(qintptr capacity,
                                                            AllocationOptions options)
{
    Q_STATIC_ASSERT(sizeof(dtkTypedArrayData) == sizeof(dtkArrayData));

    return static_cast<dtkTypedArrayData *>(
            dtkArrayData::allocate(sizeof(T), Q_ALIGNOF(AlignmentDummy), capacity, options));
}

template<typename T>
inline void dtkTypedArrayData<T>::deallocate(dtkArrayData *data)
{
    Q_STATIC_ASSERT(sizeof(dtkTypedArrayData) == sizeof(dtkArrayData));
...
template<typename T>
inline dtkTypedArrayData<T> *dtkTypedArrayData<T>::fromRawData(const T *data, qintptr n,
                                                               AllocationOptions options)
{
    Q_STATIC_ASSERT(sizeof(dtkTypedArrayData) == sizeof(dtkArrayData));
    ...
    if (result) {
        ...
        result->offset =
                reinterpret_cast<const char *>(data) - reinterpret_cast<const char *>(result);
        result->size = n;
    }
...
template<typename T>
inline dtkTypedArrayData<T> *dtkTypedArrayData<T>::sharedNull(void)
{
    Q_STATIC_ASSERT(sizeof(dtkTypedArrayData) == sizeof(dtkArrayData));
...
template<typename T>
inline dtkTypedArrayData<T> *dtkTypedArrayData<T>::sharedEmpty(void)
{
    Q_STATIC_ASSERT(sizeof(dtkTypedArrayData) == sizeof(dtkArrayData));
...
template<typename T>
inline dtkTypedArrayData<T> *dtkTypedArrayData<T>::unsharableEmpty(void)
{
    Q_STATIC_ASSERT(sizeof(dtkTypedArrayData) == sizeof(dtkArrayData));
