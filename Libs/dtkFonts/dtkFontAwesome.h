...
// ///////////////////////////////////////////////////////////////////
// dtkFontAwesomeIconPainter
// ///////////////////////////////////////////////////////////////////

class dtkFontAwesomeIconPainter;

// ///////////////////////////////////////////////////////////////////
// dtkFontAwesome
// ///////////////////////////////////////////////////////////////////

class DTKFONTS_EXPORT dtkFontAwesome : public QObject
{
    Q_OBJECT

public:
    static dtkFontAwesome *instance(void);

protected:
    static dtkFontAwesome *s_instance;
...
public:
    ...
    QIcon icon(dtkFontAwesomeIconPainter *painter, const QVariantMap& optionMap = QVariantMap());

    void give(const QString& name, dtkFontAwesomeIconPainter *painter);
...
private:
    explicit dtkFontAwesome(QObject *parent = 0);
    virtual ~dtkFontAwesome(void);

private:
    QString fontName_;
    QHash<QString,int> namedCodepoints_;
    QHash<QString, dtkFontAwesomeIconPainter*> painterMap_;
    QVariantMap defaultOptions_;
    dtkFontAwesomeIconPainter* fontIconPainter_;
};
...
class DTKFONTS_EXPORT dtkFontAwesomeIconPainter
{
public:
    virtual ~dtkFontAwesomeIconPainter(void) {}

public:
    virtual void paint(dtkFontAwesome *awesome, QPainter *painter, const QRect& rect, QIcon::Mode mode, QIcon::State state, const QVariantMap& options) = 0;
};

//
// dtkFontAwesome.h ends here
