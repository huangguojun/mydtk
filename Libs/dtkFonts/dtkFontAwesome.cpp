...
{
public:
    virtual void paint(dtkFontAwesome *awesome, QPainter *painter, const QRect &rect,
...
{
public:
    dtkFontAwesomeIconPainterIconEngine(dtkFontAwesome *awesome, dtkFontAwesomeIconPainter *painter,
...
dtkFontAwesome::dtkFontAwesome(QObject *parent) : QObject(parent), namedCodepoints_()
{
...
{
    dtkFontAwesomeIconPainterIconEngine *engine =
            new dtkFontAwesomeIconPainterIconEngine(this, painter, optionMap);
