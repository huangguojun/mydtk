...
#include "dtkFontAwesome.h"

// ///////////////////////////////////////////////////////////////////
// dtkFontAwesomeCharIconPainter
// ///////////////////////////////////////////////////////////////////

class dtkFontAwesomeCharIconPainter: public dtkFontAwesomeIconPainter
{
public:
    virtual void paint(dtkFontAwesome *awesome, QPainter *painter, const QRect& rect, QIcon::Mode mode, QIcon::State state, const QVariantMap& options)
    {
        Q_UNUSED(mode);
        Q_UNUSED(state);
        Q_UNUSED(options);
...
// ///////////////////////////////////////////////////////////////////
// dtkFontAwesomeIconPainterIconEngine
// ///////////////////////////////////////////////////////////////////

class dtkFontAwesomeIconPainterIconEngine : public QIconEngine
{
public:
    dtkFontAwesomeIconPainterIconEngine(dtkFontAwesome *awesome, dtkFontAwesomeIconPainter *painter, const QVariantMap& options)
        : awesomeRef_(awesome)
    ...
    virtual ~dtkFontAwesomeIconPainterIconEngine(void) {}

    dtkFontAwesomeIconPainterIconEngine *clone(void) const
    {
        return new dtkFontAwesomeIconPainterIconEngine(awesomeRef_, iconPainterRef_, options_);
    }
...
private:
    dtkFontAwesome *awesomeRef_;
    dtkFontAwesomeIconPainter *iconPainterRef_;
...
dtkFontAwesome::dtkFontAwesome(QObject *parent)
    : QObject(parent)
    , namedCodepoints_()
{
    ...
    fontIconPainter_ = new dtkFontAwesomeCharIconPainter();
}

dtkFontAwesome::~dtkFontAwesome(void)
{
    delete fontIconPainter_;
    qDeleteAll(painterMap_);
}

void dtkFontAwesome::init(const QString& fontname)
{
    fontName_ = fontname;
}
...
bool dtkFontAwesome::initFontAwesome()
{
    static int fontAwesomeFontId = -1;

    if(fontAwesomeFontId < 0) {

        QFile res(":dtkFontAwesome.ttf");
...
void dtkFontAwesome::addNamedCodepoint(const QString& name, int codePoint)
{
    namedCodepoints_.insert(name, codePoint);
}


void dtkFontAwesome::setDefaultOption(const QString& name, const QVariant& value)
{
    defaultOptions_.insert(name, value);
}

QVariant dtkFontAwesome::defaultOption(const QString& name)
{
...
QIcon dtkFontAwesome::icon(int character, const QVariantMap &options)
{
...
QIcon dtkFontAwesome::icon(const QString& name, const QVariantMap& options)
{
    ...
    dtkFontAwesomeIconPainter *painter = painterMap_.value(name);
...
QIcon dtkFontAwesome::icon(dtkFontAwesomeIconPainter *painter, const QVariantMap& optionMap)
{
    dtkFontAwesomeIconPainterIconEngine *engine = new dtkFontAwesomeIconPainterIconEngine(this, painter, optionMap);

    return QIcon(engine);
}

void dtkFontAwesome::give(const QString& name, dtkFontAwesomeIconPainter *painter)
{
...
QFont dtkFontAwesome::font(int size)
{
...
dtkFontAwesome *dtkFontAwesome::instance(void)
{
    if(!s_instance)
        s_instance = new dtkFontAwesome;

    return s_instance;
}

dtkFontAwesome *dtkFontAwesome::s_instance = Q_NULLPTR;

//
// dtkFontAwesome.cpp ends here
