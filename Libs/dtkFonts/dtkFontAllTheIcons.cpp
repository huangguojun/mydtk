...
{
public:
    virtual void paint(dtkFontAllTheIcons *awesome, QPainter *painter, const QRect &rect,
...
{
public:
    dtkFontAllTheIconsIconPainterIconEngine(dtkFontAllTheIcons *awesome,
                                            dtkFontAllTheIconsIconPainter *painter,
...
{
    dtkFontAllTheIconsIconPainterIconEngine *engine =
            new dtkFontAllTheIconsIconPainterIconEngine(this, painter, optionMap);
