...
DTKMATHSUPPORT_EXPORT void dtkMinMaxValueOfArray(const qint32 *array, const qint32 &size,
                                                 qint32 *minValue, qint32 *maxValue);
DTKMATHSUPPORT_EXPORT void dtkMinMaxValueOfArray(const qint64 *array, const qint64 &size,
                                                 qint64 *minValue, qint64 *maxValue);
DTKMATHSUPPORT_EXPORT void dtkMinMaxValueOfArray(const qreal *array, const qlonglong &size,
                                                 qreal *minValue, qreal *maxValue);
...
DTKMATHSUPPORT_EXPORT bool
dtkAlmostEqualRelativeOrAbsolute(float A, float B, float maxRelativeError, float maxAbsoluteError);
DTKMATHSUPPORT_EXPORT bool dtkAlmostEqualRelativeOrAbsolute(double A, double B,
...
DTKMATHSUPPORT_EXPORT bool dtkAlmostEqualMixedAbsoluteRelative(const double A, const double B,
