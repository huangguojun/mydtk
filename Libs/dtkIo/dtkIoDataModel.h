...
public:
    virtual void write(const QString& dataset_name, DataType type, int dimension, quint64 *shape, void *values = NULL) = 0;

public:
    virtual void readByCoord(const QString& dataset_name, DataType type, quint64 nb_points, quint64 *points_coord, void *values);
public:
    virtual void writeHyperslab(const QString& dataset_name, DataType type, quint64 *offset, quint64 *stride, quint64 *count, quint64 *block, quint64 *values_shape, void *values);
    virtual void writeByCoord(const QString& dataset_name, DataType type, quint64 nb_points, quint64 *points_coord, void *values);
};
