...
{
public:
  static NetworkPacket* BuildEthernetIP4UDP(const unsigned char* payload, unsigned int payloadSize,
    const unsigned char* sourceIPv4BigEndian, unsigned short sourcePort,
