...
public:
    ...
    // Note that the memory zone returned by P->GetPayloadData() has a lifetime
    // equal to the instance P of NetworkPacket (no copy is done), and must not
    // be freed by the user of NetworkPacket
