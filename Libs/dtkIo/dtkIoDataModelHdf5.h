...
public:
    void write(const QString& dataset_name, DataType type, int dimension, quint64 *shape, void *values)  override;
...
public:
    ...
    void writeByCoord(const QString &dataset_name, DataType type, quint64 nb_points, quint64* points_coord, void *values = nullptr)  override;
