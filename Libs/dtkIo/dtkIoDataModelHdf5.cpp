...
hid_t &
dtkIoDataModelHdf5Private::datasetId(const QString &dataset_name,
 ...
 * dimensions
 */
void dtkIoDataModelHdf5::write(const QString &dataset_name, DataType type, int dimension,
                               quint64 *shape, void *values)
{
    ...
    if (values) {
        ...
        case dtkIoDataModel::LongLongInt: {
            d->status =
                    H5Dwrite(dataset_id, H5T_NATIVE_LLONG, H5S_ALL, H5S_ALL, H5P_DEFAULT, values);
            break;
        }
        case dtkIoDataModel::Double: {
            d->status =
                    H5Dwrite(dataset_id, H5T_NATIVE_DOUBLE, H5S_ALL, H5S_ALL, H5P_DEFAULT, values);
            break;
        }
        default:
...
// hyperslab write
void dtkIoDataModelHdf5::writeHyperslab(const QString &dataset_name, DataType type, quint64 *offset,
...
void dtkIoDataModelHdf5::writeByCoord(const QString &dataset_name, DataType type, quint64 nb_points,
